(function () {
  ...
  var RELEASE_CANDIDATE_DEMOS = {
    ...
    v02_staging_qualification_authorization: "demo-data/v02-staging-qualification-authorization.json",
    v02_staging_environment_profile: "demo-data/v02-staging-environment-profile.json",
    v02_staging_build_plan: "demo-data/v02-staging-build-plan.json",
    v02_staging_artifact_boundary: "demo-data/v02-staging-artifact-boundary.json",
    v02_staging_rollback_boundary: "demo-data/v02-staging-rollback-boundary.json",
    v02_staging_runtime_hold: "demo-data/v02-staging-runtime-hold.json",
