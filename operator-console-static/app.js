(function () {
  ...
  var VIEW_DEMOS = {
    ...
    adaptive_intelligence_program: "demo-data/adaptive-intelligence-program.json",
    external_cognition_authorization: "demo-data/external-cognition-authorization.json",
    external_cognition_foundation: "demo-data/external-cognition-foundation.json",
    external_cognition_static_console_evidence:
      "demo-data/external-cognition-static-console-evidence.json",
    adaptive_intelligence_runtime_hold: "demo-data/adaptive-intelligence-runtime-hold.json",
    ...
    knowledge_intelligence_domain_expert_mesh: "demo-data/knowledge-intelligence-domain-expert-mesh.json",
    knowledge_intelligence_domain_expert_panel: "demo-data/knowledge-intelligence-domain-expert-panel.json",
    knowledge_intelligence_domain_expert_reports: "demo-data/knowledge-intelligence-domain-expert-reports.json",
    knowledge_intelligence_domain_expert_critiques: "demo-data/knowledge-intelligence-domain-expert-critiques.json",
    knowledge_intelligence_domain_expert_disagreement: "demo-data/knowledge-intelligence-domain-expert-disagreement.json",
    knowledge_intelligence_domain_expert_synthesis: "demo-data/knowledge-intelligence-domain-expert-synthesis.json",
    ...
    knowledge_intelligence_verified_memory: "demo-data/knowledge-intelligence-verified-memory.json",
    knowledge_intelligence_verified_candidate_support: "demo-data/knowledge-intelligence-verified-candidate-support.json",
    knowledge_intelligence_verified_candidate_refutation: "demo-data/knowledge-intelligence-verified-candidate-refutation.json",
    knowledge_intelligence_verified_candidate_revalidation: "demo-data/knowledge-intelligence-verified-candidate-revalidation.json",
    knowledge_intelligence_verified_candidate_integrity: "demo-data/knowledge-intelligence-verified-candidate-integrity.json",
    ...
    governed_learning_memory_promotion_evaluation: "demo-data/governed-learning-memory-promotion-evaluation.json",
    governed_learning_memory_local_persistence_authorization: "demo-data/governed-learning-memory-local-persistence-authorization.json",
    governed_learning_memory_local_persistence_approval: "demo-data/governed-learning-memory-local-persistence-approval.json",
    governed_learning_memory_local_persistence_schema: "demo-data/governed-learning-memory-local-persistence-schema.json",
    governed_learning_memory_local_persistence_version: "demo-data/governed-learning-memory-local-persistence-version.json",
    governed_learning_memory_local_persistence_projection: "demo-data/governed-learning-memory-local-persistence-projection.json",
    governed_learning_memory_local_persistence_integrity: "demo-data/governed-learning-memory-local-persistence-integrity.json",
    governed_learning_memory_local_persistence_runtime_hold: "demo-data/governed-learning-memory-local-persistence-runtime-hold.json",
    governed_learning_memory_local_persistence_evaluation: "demo-data/governed-learning-memory-local-persistence-evaluation.json",
    governed_learning_memory_engagement_application_authorization: "demo-data/governed-learning-memory-engagement-application-authorization.json",
    governed_learning_memory_engagement_candidate_binding: "demo-data/governed-learning-memory-engagement-candidate-binding.json",
    governed_learning_memory_engagement_risk_policy: "demo-data/governed-learning-memory-engagement-risk-policy.json",
    governed_learning_memory_engagement_overlay: "demo-data/governed-learning-memory-engagement-overlay.json",
    governed_learning_memory_engagement_counterfactual: "demo-data/governed-learning-memory-engagement-counterfactual.json",
    governed_learning_memory_engagement_integrity: "demo-data/governed-learning-memory-engagement-integrity.json",
    governed_learning_memory_engagement_runtime_hold: "demo-data/governed-learning-memory-engagement-runtime-hold.json",
    governed_learning_memory_engagement_authorization: "demo-data/governed-learning-memory-engagement-authorization.json",
    governed_learning_memory_engagement_lifecycle_evidence: "demo-data/governed-learning-memory-engagement-lifecycle-evidence.json",
    governed_learning_memory_engagement_risk_assessment: "demo-data/governed-learning-memory-engagement-risk-assessment.json",
    governed_learning_memory_engagement_approval_bundle: "demo-data/governed-learning-memory-engagement-approval-bundle.json",
    governed_learning_memory_engagement_adaptation_identity: "demo-data/governed-learning-memory-engagement-adaptation-identity.json",
    governed_learning_memory_engagement_conflict_report: "demo-data/governed-learning-memory-engagement-conflict-report.json",
    governed_learning_memory_engagement_version_plan: "demo-data/governed-learning-memory-engagement-version-plan.json",
    governed_learning_memory_engagement_target_policy: "demo-data/governed-learning-memory-engagement-target-policy.json",
    governed_learning_memory_engagement_baseline_snapshot: "demo-data/governed-learning-memory-engagement-baseline-snapshot.json",
    governed_learning_memory_engagement_overlay_record: "demo-data/governed-learning-memory-engagement-overlay-record.json",
    governed_learning_memory_engagement_overlay_snapshot: "demo-data/governed-learning-memory-engagement-overlay-snapshot.json",
    governed_learning_memory_engagement_counterfactual_result: "demo-data/governed-learning-memory-engagement-counterfactual-result.json",
    governed_learning_memory_engagement_metric_delta: "demo-data/governed-learning-memory-engagement-metric-delta.json",
    governed_learning_memory_engagement_rollback_plan: "demo-data/governed-learning-memory-engagement-rollback-plan.json",
    governed_learning_memory_engagement_application_plan: "demo-data/governed-learning-memory-engagement-application-plan.json",
    governed_learning_memory_engagement_application_result: "demo-data/governed-learning-memory-engagement-application-result.json",
    governed_learning_memory_engagement_integrity_report: "demo-data/governed-learning-memory-engagement-integrity-report.json",
    governed_learning_memory_engagement_synthetic_pilot: "demo-data/governed-learning-memory-engagement-synthetic-pilot.json",
    governed_learning_memory_engagement_runtime_boundary: "demo-data/governed-learning-memory-engagement-runtime-boundary.json",
    governed_learning_memory_engagement_evaluation: "demo-data/governed-learning-memory-engagement-evaluation.json",
    governed_learning_memory_continual_learning_authorization: "demo-data/governed-learning-memory-continual-learning-authorization.json",
    governed_learning_memory_continual_learning_cycle: "demo-data/governed-learning-memory-continual-learning-cycle.json",
    governed_learning_memory_continual_learning_research: "demo-data/governed-learning-memory-continual-learning-research.json",
    governed_learning_memory_continual_learning_persistence: "demo-data/governed-learning-memory-continual-learning-persistence.json",
    governed_learning_memory_continual_learning_shadow: "demo-data/governed-learning-memory-continual-learning-shadow.json",
    governed_learning_memory_continual_learning_outcome: "demo-data/governed-learning-memory-continual-learning-outcome.json",
    governed_learning_memory_continual_learning_runtime_hold: "demo-data/governed-learning-memory-continual-learning-runtime-hold.json",
    governed_learning_memory_program_final_evaluation: "demo-data/governed-learning-memory-program-final-evaluation.json",
    governed_learning_memory_program_final_closeout: "demo-data/governed-learning-memory-program-final-closeout.json",
    governed_learning_memory_program_final_capability_matrix: "demo-data/governed-learning-memory-program-final-capability-matrix.json",
    governed_learning_memory_program_final_runtime_boundary: "demo-data/governed-learning-memory-program-final-runtime-boundary.json",
    governed_learning_memory_program_final_lineage: "demo-data/governed-learning-memory-program-final-lineage.json",
    secure_runtime_integration_program: "demo-data/secure-runtime-integration-program.json",
    secure_runtime_integration_authorization: "demo-data/secure-runtime-integration-authorization.json",
    secure_runtime_integration_session: "demo-data/secure-runtime-integration-session.json",
    secure_runtime_integration_runtime_guard: "demo-data/secure-runtime-integration-runtime-guard.json",
    secure_runtime_integration_kill_switch: "demo-data/secure-runtime-integration-kill-switch.json",
    secure_runtime_integration_runtime_hold: "demo-data/secure-runtime-integration-runtime-hold.json",
    secure_runtime_integration_identity_binding: "demo-data/secure-runtime-integration-identity-binding.json",
    secure_runtime_integration_request_identity: "demo-data/secure-runtime-integration-request-identity.json",
    secure_runtime_integration_actor_context: "demo-data/secure-runtime-integration-actor-context.json",
    secure_runtime_integration_session_state: "demo-data/secure-runtime-integration-session-state.json",
    secure_runtime_integration_stage_command: "demo-data/secure-runtime-integration-stage-command.json",
    secure_runtime_integration_stage_receipt: "demo-data/secure-runtime-integration-stage-receipt.json",
    secure_runtime_integration_capability_plan: "demo-data/secure-runtime-integration-capability-plan.json",
    secure_runtime_integration_policy_binding: "demo-data/secure-runtime-integration-policy-binding.json",
    secure_runtime_integration_risk_binding: "demo-data/secure-runtime-integration-risk-binding.json",
    secure_runtime_integration_guardrail_binding: "demo-data/secure-runtime-integration-guardrail-binding.json",
    secure_runtime_integration_approval_bundle: "demo-data/secure-runtime-integration-approval-bundle.json",
    secure_runtime_integration_simulated_dispatch: "demo-data/secure-runtime-integration-simulated-dispatch.json",
    secure_runtime_integration_audit: "demo-data/secure-runtime-integration-audit.json",
    secure_runtime_integration_observability: "demo-data/secure-runtime-integration-observability.json",
    secure_runtime_integration_health: "demo-data/secure-runtime-integration-health.json",
    secure_runtime_integration_checkpoint: "demo-data/secure-runtime-integration-checkpoint.json",
    secure_runtime_integration_integrity: "demo-data/secure-runtime-integration-integrity.json",
    secure_runtime_integration_pilot_evidence: "demo-data/secure-runtime-integration-pilot-evidence.json",
    secure_runtime_integration_runtime_boundary: "demo-data/secure-runtime-integration-runtime-boundary.json",
    secure_runtime_foundation_operator_evaluation: "demo-data/secure-runtime-foundation-operator-evaluation.json",
    model_gateway_authorization: "demo-data/model-gateway-authorization.json",
    model_gateway_component_binding: "demo-data/model-gateway-component-binding.json",
    model_gateway_provider_manifest: "demo-data/model-gateway-provider-manifest.json",
    model_gateway_model_manifests: "demo-data/model-gateway-model-manifests.json",
    model_gateway_session_plan: "demo-data/model-gateway-session-plan.json",
    model_gateway_message_normalization: "demo-data/model-gateway-message-normalization.json",
    model_gateway_routing_plan: "demo-data/model-gateway-routing-plan.json",
    model_gateway_fallback_plan: "demo-data/model-gateway-fallback-plan.json",
    model_gateway_retry_plan: "demo-data/model-gateway-retry-plan.json",
    model_gateway_circuit_breaker: "demo-data/model-gateway-circuit-breaker.json",
    model_gateway_guard: "demo-data/model-gateway-guard.json",
    model_gateway_reference_provider_response: "demo-data/model-gateway-reference-provider-response.json",
    model_gateway_budget: "demo-data/model-gateway-budget.json",
    model_gateway_output_validation: "demo-data/model-gateway-output-validation.json",
    model_gateway_output_provenance: "demo-data/model-gateway-output-provenance.json",
    model_gateway_audit: "demo-data/model-gateway-audit.json",
    model_gateway_observability: "demo-data/model-gateway-observability.json",
    model_gateway_health: "demo-data/model-gateway-health.json",
    model_gateway_integrity: "demo-data/model-gateway-integrity.json",
    model_gateway_pilot_evidence: "demo-data/model-gateway-pilot-evidence.json",
    model_gateway_runtime_boundary: "demo-data/model-gateway-runtime-boundary.json",
    model_gateway_static_console_evidence: "demo-data/model-gateway-static-console-evidence.json",
    model_gateway_runtime_hold: "demo-data/model-gateway-runtime-hold.json",
    model_gateway_operator_evaluation: "demo-data/model-gateway-operator-evaluation.json",
    capability_runtime_authorization: "demo-data/capability-runtime-authorization.json",
    capability_runtime_component_binding: "demo-data/capability-runtime-component-binding.json",
    capability_runtime_model_proposal_binding: "demo-data/capability-runtime-model-proposal-binding.json",
    capability_runtime_manifests: "demo-data/capability-runtime-manifests.json",
    capability_runtime_request: "demo-data/capability-runtime-request-envelope.json",
    capability_runtime_execution_plan: "demo-data/capability-runtime-execution-plan.json",
    capability_runtime_policy_binding: "demo-data/capability-runtime-policy-binding.json",
    capability_runtime_risk_binding: "demo-data/capability-runtime-risk-binding.json",
    capability_runtime_guardrail_binding: "demo-data/capability-runtime-guardrail-binding.json",
    capability_runtime_approval: "demo-data/capability-runtime-approval-evidence.json",
    capability_runtime_sandbox: "demo-data/capability-runtime-sandbox.json",
    capability_runtime_sandbox_decision: "demo-data/capability-runtime-sandbox-decision.json",
    capability_runtime_budget: "demo-data/capability-runtime-budget.json",
    capability_runtime_execution_receipt: "demo-data/capability-runtime-execution-receipt.json",
    capability_runtime_connector_preview: "demo-data/capability-runtime-connector-preview.json",
    capability_runtime_rollback: "demo-data/capability-runtime-rollback.json",
    capability_runtime_audit: "demo-data/capability-runtime-audit.json",
    capability_runtime_observability: "demo-data/capability-runtime-observability.json",
    capability_runtime_health: "demo-data/capability-runtime-health.json",
    capability_runtime_integrity: "demo-data/capability-runtime-integrity.json",
    capability_runtime_pilot_evidence: "demo-data/capability-runtime-local-sandbox-pilot-evidence.json",
    capability_runtime_runtime_boundary: "demo-data/capability-runtime-runtime-boundary.json",
    capability_runtime_runtime_hold: "demo-data/capability-runtime-runtime-hold.json",
    capability_runtime_operator_evaluation: "demo-data/capability-runtime-operator-evaluation.json",
    operator_console_integration_authorization: "demo-data/operator-console-integration-authorization.json",
    operator_console_route_manifest: "demo-data/operator-console-route-manifest.json",
    operator_console_integration_runtime_hold: "demo-data/operator-console-integration-runtime-hold.json",
    operator_console_component_binding: "demo-data/operator-console-integration-component-binding.json",
    operator_console_static_asset_manifest: "demo-data/operator-console-static-asset-manifest.json",
    operator_console_origin_policy: "demo-data/operator-console-origin-policy.json",
    operator_console_mutation_nonce_state: "demo-data/operator-console-mutation-nonce-state.json",
    operator_console_session_bootstrap: "demo-data/operator-console-session-bootstrap.json",
    operator_console_session_status: "demo-data/operator-console-session-status.json",
    operator_console_health: "demo-data/operator-console-health.json",
    operator_console_observability: "demo-data/operator-console-observability.json",
    operator_console_audit: "demo-data/operator-console-audit.json",
    operator_console_model_simulation: "demo-data/operator-console-model-simulation.json",
    operator_console_capability_execution: "demo-data/operator-console-capability-execution.json",
    operator_console_connector_read: "demo-data/operator-console-connector-read.json",
    operator_console_connector_write_preview: "demo-data/operator-console-connector-write-preview.json",
    operator_console_kill_switch_result: "demo-data/operator-console-kill-switch-result.json",
    operator_console_session_close_result: "demo-data/operator-console-session-close-result.json",
    operator_console_receipt_projection: "demo-data/operator-console-receipt-projection.json",
    operator_console_integrity: "demo-data/operator-console-integrity.json",
    operator_console_integrated_pilot_evidence:
      "demo-data/operator-console-integrated-local-runtime-pilot-evidence.json",
    operator_console_runtime_boundary: "demo-data/operator-console-runtime-boundary.json",
  ...
  var VIEW_GROUPS = {
    ...
    knowledge: [
      ...
      "knowledge_intelligence_domain_expert_mesh",
      "knowledge_intelligence_domain_expert_panel",
      "knowledge_intelligence_domain_expert_reports",
      "knowledge_intelligence_domain_expert_critiques",
      "knowledge_intelligence_domain_expert_disagreement",
      ...
      "knowledge_intelligence_verified_memory",
      "knowledge_intelligence_verified_candidate_support",
      "knowledge_intelligence_verified_candidate_refutation",
      "knowledge_intelligence_verified_candidate_revalidation",
      ...
      "adaptive_intelligence_program",
      "external_cognition_authorization",
      "external_cognition_foundation",
      "external_cognition_static_console_evidence",
      "adaptive_intelligence_runtime_hold",
      ...
      "governed_learning_memory_promotion_evaluation",
      "governed_learning_memory_local_persistence_authorization",
      "governed_learning_memory_local_persistence_approval",
      "governed_learning_memory_local_persistence_schema",
      "governed_learning_memory_local_persistence_version",
      "governed_learning_memory_local_persistence_projection",
      "governed_learning_memory_local_persistence_integrity",
      "governed_learning_memory_local_persistence_runtime_hold",
      "governed_learning_memory_local_persistence_evaluation",
      "governed_learning_memory_engagement_application_authorization",
      "governed_learning_memory_engagement_candidate_binding",
      "governed_learning_memory_engagement_risk_policy",
      "governed_learning_memory_engagement_overlay",
      "governed_learning_memory_engagement_counterfactual",
      "governed_learning_memory_engagement_integrity",
      "governed_learning_memory_engagement_runtime_hold",
      "governed_learning_memory_engagement_authorization",
      "governed_learning_memory_engagement_lifecycle_evidence",
      "governed_learning_memory_engagement_risk_assessment",
      "governed_learning_memory_engagement_approval_bundle",
      "governed_learning_memory_engagement_adaptation_identity",
      "governed_learning_memory_engagement_conflict_report",
      "governed_learning_memory_engagement_version_plan",
      "governed_learning_memory_engagement_target_policy",
      "governed_learning_memory_engagement_baseline_snapshot",
      "governed_learning_memory_engagement_overlay_record",
      "governed_learning_memory_engagement_overlay_snapshot",
      "governed_learning_memory_engagement_counterfactual_result",
      "governed_learning_memory_engagement_metric_delta",
      "governed_learning_memory_engagement_rollback_plan",
      "governed_learning_memory_engagement_application_plan",
      "governed_learning_memory_engagement_application_result",
      "governed_learning_memory_engagement_integrity_report",
      "governed_learning_memory_engagement_synthetic_pilot",
      "governed_learning_memory_engagement_runtime_boundary",
      "governed_learning_memory_engagement_evaluation",
      "governed_learning_memory_continual_learning_authorization",
      "governed_learning_memory_continual_learning_cycle",
      "governed_learning_memory_continual_learning_research",
      "governed_learning_memory_continual_learning_persistence",
      "governed_learning_memory_continual_learning_shadow",
      "governed_learning_memory_continual_learning_outcome",
      "governed_learning_memory_continual_learning_runtime_hold",
      "governed_learning_memory_program_final_evaluation",
      "governed_learning_memory_program_final_closeout",
      "governed_learning_memory_program_final_capability_matrix",
      "governed_learning_memory_program_final_runtime_boundary",
      "governed_learning_memory_program_final_lineage",
      "secure_runtime_integration_program",
      "secure_runtime_integration_authorization",
      "secure_runtime_integration_session",
      "secure_runtime_integration_runtime_guard",
      "secure_runtime_integration_kill_switch",
      "secure_runtime_integration_runtime_hold",
      "secure_runtime_integration_identity_binding",
      "secure_runtime_integration_request_identity",
      "secure_runtime_integration_actor_context",
      "secure_runtime_integration_session_state",
      "secure_runtime_integration_stage_command",
      "secure_runtime_integration_stage_receipt",
      "secure_runtime_integration_capability_plan",
      "secure_runtime_integration_policy_binding",
      "secure_runtime_integration_risk_binding",
      "secure_runtime_integration_guardrail_binding",
      "secure_runtime_integration_approval_bundle",
      "secure_runtime_integration_simulated_dispatch",
      "secure_runtime_integration_audit",
      "secure_runtime_integration_observability",
      "secure_runtime_integration_health",
      "secure_runtime_integration_checkpoint",
      "secure_runtime_integration_integrity",
      "secure_runtime_integration_pilot_evidence",
      "secure_runtime_integration_runtime_boundary",
      "v02_release_qualification_parent_program_binding",
      "v02_release_qualification_production_auth_composition",
      "v02_release_qualification_request_identity_integration",
      "v02_release_qualification_replay_provisioning",
      "v02_release_qualification_runtime_guard",
      "v02_release_qualification_release_gates",
      "v02_release_qualification_pilot_evidence",
      "v02_staging_qualification_authorization",
      "v02_staging_source_snapshot",
      "v02_staging_build_plan",
      "v02_staging_artifact_manifest",
      "v02_staging_sbom",
      "v02_staging_provenance",
      "v02_staging_reproducibility_comparison",
      "v02_staging_environment_profile",
      "v02_staging_identity_fixture",
      "v02_staging_replay_fixture",
      "v02_staging_deployment",
      "v02_staging_health",
      "v02_staging_readiness",
      "v02_staging_security_validation",
      "v02_staging_observability",
      "v02_staging_degradation",
      "v02_staging_rollback_boundary",
      "v02_staging_cleanup",
      "v02_staging_pilot_evidence",
      "v02_staging_runtime_hold",
      "secure_runtime_integration_identity_binding",
      "secure_runtime_integration_request_identity",
      "secure_runtime_integration_actor_context",
      "secure_runtime_integration_session_state",
      ...
      "secure_runtime_integration_pilot_evidence",
      "secure_runtime_integration_runtime_boundary",
      "secure_runtime_foundation_operator_evaluation",
      "model_gateway_authorization",
      "model_gateway_component_binding",
      "model_gateway_provider_manifest",
      "model_gateway_model_manifests",
      "model_gateway_session_plan",
      "model_gateway_message_normalization",
      "model_gateway_routing_plan",
      "model_gateway_fallback_plan",
      "model_gateway_retry_plan",
      "model_gateway_circuit_breaker",
      "model_gateway_guard",
      "model_gateway_reference_provider_response",
      "model_gateway_budget",
      "model_gateway_output_validation",
      "model_gateway_output_provenance",
      "model_gateway_audit",
      "model_gateway_observability",
      "model_gateway_health",
      "model_gateway_integrity",
      "model_gateway_pilot_evidence",
      "model_gateway_runtime_boundary",
      "model_gateway_static_console_evidence",
      "model_gateway_runtime_hold",
      "capability_runtime_authorization",
      "capability_runtime_component_binding",
      "capability_runtime_model_proposal_binding",
      "capability_runtime_manifests",
      "capability_runtime_request",
      "capability_runtime_execution_plan",
      "capability_runtime_policy_binding",
      "capability_runtime_risk_binding",
      "capability_runtime_guardrail_binding",
      "capability_runtime_approval",
      "capability_runtime_budget",
      "capability_runtime_sandbox",
      "capability_runtime_sandbox_decision",
      "capability_runtime_execution_receipt",
      "capability_runtime_connector_preview",
      "capability_runtime_rollback",
      "capability_runtime_audit",
      "capability_runtime_observability",
      "capability_runtime_health",
      "capability_runtime_integrity",
      "capability_runtime_pilot_evidence",
      "capability_runtime_runtime_boundary",
      "capability_runtime_runtime_hold",
      "capability_runtime_operator_evaluation",
      "operator_console_integration_authorization",
      "operator_console_route_manifest",
      "operator_console_integration_runtime_hold",
      "operator_console_component_binding",
      "operator_console_static_asset_manifest",
      "operator_console_origin_policy",
      "operator_console_mutation_nonce_state",
      "operator_console_session_bootstrap",
      "operator_console_session_status",
      "operator_console_health",
      "operator_console_observability",
      "operator_console_audit",
      "operator_console_model_simulation",
      "operator_console_capability_execution",
      "operator_console_connector_read",
      "operator_console_connector_write_preview",
      "operator_console_kill_switch_result",
      "operator_console_session_close_result",
      "operator_console_receipt_projection",
      "operator_console_integrity",
      "operator_console_integrated_pilot_evidence",
      "operator_console_runtime_boundary",
      "governed_learning_memory_engagement_authorization",
      "governed_learning_memory_engagement_lifecycle_evidence",
      "governed_learning_memory_engagement_risk_assessment",
      "governed_learning_memory_engagement_approval_bundle",
  ...
  var RELEASE_CANDIDATE_DEMOS = {
    ...
    production_auth_authorization: "demo-data/v02-production-auth-authorization.json",
    production_auth_runtime_guard_hold: "demo-data/v02-production-auth-runtime-guard-hold.json",
    ...
    v02_release_qualification_parent_program_binding: "demo-data/v02-release-qualification-parent-program-binding.json",
    v02_release_qualification_production_auth_composition: "demo-data/v02-release-qualification-production-auth-composition.json",
    v02_release_qualification_request_identity_integration: "demo-data/v02-release-qualification-request-identity-integration.json",
    v02_release_qualification_replay_provisioning: "demo-data/v02-release-qualification-replay-provisioning.json",
    v02_release_qualification_runtime_guard: "demo-data/v02-release-qualification-runtime-guard.json",
    v02_release_qualification_release_gates: "demo-data/v02-release-qualification-release-gates.json",
    v02_release_qualification_pilot_evidence: "demo-data/v02-release-qualification-pilot-evidence.json",
    v02_qualification_foundation_operator_evaluation: "demo-data/v02-qualification-foundation-operator-evaluation.json",
    v02_staging_qualification_authorization: "demo-data/v02-release-qualification-staging-authorization.json",
    v02_staging_environment_profile: "demo-data/v02-release-qualification-staging-environment-profile.json",
    v02_staging_build_plan: "demo-data/v02-release-qualification-staging-build-plan.json",
    v02_staging_artifact_boundary: "demo-data/v02-staging-artifact-boundary.json",
    v02_staging_source_snapshot: "demo-data/v02-release-qualification-staging-source-snapshot.json",
    v02_staging_artifact_manifest: "demo-data/v02-release-qualification-staging-artifact-manifest.json",
    v02_staging_sbom: "demo-data/v02-release-qualification-staging-sbom.json",
    v02_staging_provenance: "demo-data/v02-release-qualification-staging-provenance.json",
    v02_staging_reproducibility_comparison: "demo-data/v02-release-qualification-staging-reproducibility-comparison.json",
    v02_staging_identity_fixture: "demo-data/v02-release-qualification-staging-identity-fixture.json",
    v02_staging_replay_fixture: "demo-data/v02-release-qualification-staging-replay-fixture.json",
    v02_staging_deployment: "demo-data/v02-release-qualification-staging-deployment.json",
    v02_staging_health: "demo-data/v02-release-qualification-staging-health.json",
    v02_staging_readiness: "demo-data/v02-release-qualification-staging-readiness.json",
    v02_staging_security_validation: "demo-data/v02-release-qualification-staging-security-validation.json",
    v02_staging_observability: "demo-data/v02-release-qualification-staging-observability.json",
    v02_staging_degradation: "demo-data/v02-release-qualification-staging-degradation.json",
    v02_staging_rollback_boundary: "demo-data/v02-release-qualification-staging-rollback.json",
    v02_staging_cleanup: "demo-data/v02-release-qualification-staging-cleanup.json",
    v02_staging_pilot_evidence: "demo-data/v02-release-qualification-staging-pilot-evidence.json",
    v02_staging_runtime_hold: "demo-data/v02-release-qualification-staging-runtime-hold.json",
  ...
  function loadReleaseCandidatePanels() {
    Promise.all([
      ...
      fetchJson(RELEASE_CANDIDATE_DEMOS.production_auth_authorization),
      fetchJson(RELEASE_CANDIDATE_DEMOS.production_auth_runtime_guard_hold),
      ...
      .then(function (payloads) {
        ...
        renderReleaseCandidateEvidence("v02-runtime-approval-board-stabilization", redact(payloads[54]));
        ...
        renderReleaseCandidateEvidence("v02-implementation-authorization-stabilization", redact(payloads[60]));
        ...
        renderReleaseCandidateEvidence("v02-production-auth-authorization", redact(payloads[66]));
        renderReleaseCandidateEvidence("v02-production-auth-runtime-guard-hold", redact(payloads[67]));
        renderReleaseCandidateEvidence("v02-production-auth-core-implementation-closeout", redact(payloads[68]));
      ...
      .catch(function () {
        ...
        renderReleaseCandidateEvidence("v02-runtime-approval-board-stabilization", { status: "unavailable" });
        ...
        renderReleaseCandidateEvidence("v02-implementation-authorization-stabilization", { status: "unavailable" });
        ...
        renderReleaseCandidateEvidence("v02-production-auth-authorization", { status: "unavailable" });
        renderReleaseCandidateEvidence("v02-production-auth-runtime-guard-hold", { status: "unavailable" });
        renderReleaseCandidateEvidence("v02-production-auth-core-implementation-closeout", { status: "unavailable" });
  ...
  function renderReleaseCandidateEvidence(containerId, payload) {
    ...
    [
      ...
      ["authorization_transaction_id", payload.authorization_transaction_id || "n/a"],
      ["approval_record_id", payload.approval_record_id || "n/a"],
      ["candidate_id", payload.candidate_id || "n/a"],
      ["authorization_scope", payload.authorization_scope || "n/a"],
      ["authorization_transaction_approved", String(Boolean(payload.authorization_transaction_approved))],
      ["authorization_governance_baseline_complete", String(Boolean(payload.authorization_governance_baseline_complete))],
      ["explicit_approval_record_approval", String(Boolean(payload.explicit_approval_record_approval))],
      ...
      ["runtime_approval_board_stabilization_approval", String(Boolean(payload.runtime_approval_board_stabilization_approval))],
      ["runtime_approval_board_final_review_approval", String(Boolean(payload.runtime_approval_board_final_review_approval))],
      ...
      ["approval_vote_record_closeout_approval", String(Boolean(payload.approval_vote_record_closeout_approval))],
      ...
      ["go_no_go_ledger_final_lock_created", String(Boolean(payload.go_no_go_ledger_final_lock_created))],
      ["implementation_go_status", String(Boolean(payload.implementation_go_status))],
      ["implementation_go_final_approval", String(Boolean(payload.implementation_go_final_approval))],
      ["implementation_no_go_status", String(Boolean(payload.implementation_no_go_status))],
      ["implementation_no_go_final_status", String(Boolean(payload.implementation_no_go_final_status))],
      ...
      ["approval_docket_lifecycle_matrix_created", String(Boolean(payload.approval_docket_lifecycle_matrix_created))],
      ...
      ["submission_approval", String(Boolean(payload.submission_approval))],
      ...
      ["preapproval_gate_bypassed", String(Boolean(payload.preapproval_gate_bypassed))],
