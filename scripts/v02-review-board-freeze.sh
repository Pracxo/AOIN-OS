...
is_nested_gate_context() {
  ...
  [[ "${AION_V02_REVIEW_BOARD_FREEZE_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
echo "v0.2 review board freeze working tree summary:"
...
cat <<SUMMARY
v0.2 review board freeze result:
