...
is_nested_gate_context() {
  ...
  [[ "${AION_V02_RUNTIME_ENABLEMENT_GUARD_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
echo "v0.2 runtime enablement guard freeze working tree summary:"
...
cat <<SUMMARY
v0.2 runtime enablement guard freeze result:
