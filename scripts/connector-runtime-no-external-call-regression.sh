...
if rg -n 'store_credential|credential_store|secret_store|token_store|store_token|external_endpoint|provider_endpoint' \
  services/brain-api/src/aion_brain/connector_runtime services/brain-api/src/aion_brain/api/connector_runtime.py examples/connectors; then
