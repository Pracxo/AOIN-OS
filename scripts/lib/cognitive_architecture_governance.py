...
AION231_ALLOWED_PREFIXES = (
    ...
    "operator-console-static/demo-data/secure-runtime-integration-",
...
AION239_ALLOWED_PREFIXES = (
    ...
    "operator-console-static/demo-data/v02-qualification-foundation-",
    "operator-console-static/demo-data/v02-staging-",
    "scripts/v02-release-qualification-",
    "scripts/v02-staging-qualification-",
...
def _aion208_path_allowed(relative: str) -> bool:
    ...
    ) or _aion211_path_allowed(relative)
