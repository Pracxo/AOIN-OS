...
is_nested_gate_context() {
  ...
  [[ "${AION_V02_PLANNING_FREEZE_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
if is_nested_gate_context; then
  echo "PASS: v0.2 planning stabilization gate deferred to outer aggregate gate"
else
  AION_AGGREGATE_GATE_RUNNING=1 ./scripts/v02-planning-stabilization-gate.sh
fi
...
echo "v0.2 planning freeze working tree summary:"
