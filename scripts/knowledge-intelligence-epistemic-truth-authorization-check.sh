...
if post_aion212:
    ...
    if post_aion216:
        ...
        expected_workstream = "knowledge-intelligence-verified-knowledge-memory"
        expected_task = "AION-217"
        expected_closeout = "AION-218"
    elif post_aion214:
        expected_auth = SUCCESSOR_AUTH_ID
        expected_scope = SUCCESSOR_SCOPE
        expected_candidate = "deterministic-tool-verification-fabric-core"
        expected_workstream = "knowledge-intelligence-tool-verification-fabric"
        expected_task = "AION-215"
        expected_closeout = "AION-216"
    else:
        expected_auth = NEXT_AUTH_ID
        expected_scope = NEXT_SCOPE
        expected_candidate = "domain-expert-mesh-core"
        expected_workstream = "knowledge-intelligence-domain-expert-mesh"
