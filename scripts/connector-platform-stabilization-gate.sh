...
is_nested_gate_context() {
  ...
  [[ "${AION_CONNECTOR_PLATFORM_STABILIZATION_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
echo "Connector platform stabilization working tree summary:"
...
cat <<SUMMARY
Connector platform stabilization gate result:
