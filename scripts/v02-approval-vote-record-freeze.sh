...
is_nested_gate_context() {
  ...
  [[ "${AION_V02_APPROVAL_VOTE_RECORD_FREEZE_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
echo "v0.2 approval vote record freeze working tree summary:"
...
cat <<SUMMARY
v0.2 approval vote record freeze result:
