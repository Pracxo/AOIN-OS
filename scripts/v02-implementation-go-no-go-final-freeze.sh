...
is_nested_gate_context() {
  ...
  [[ "${AION_V02_IMPLEMENTATION_GO_NO_GO_FINAL_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
echo "v0.2 implementation go/no-go final freeze working tree summary:"
...
cat <<SUMMARY
v0.2 implementation go/no-go final freeze result:
