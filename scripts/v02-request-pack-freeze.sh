...
is_nested_gate_context() {
  ...
  [[ "${AION_V02_REQUEST_PACK_FREEZE_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
echo "v0.2 request pack freeze working tree summary:"
...
cat <<SUMMARY
v0.2 request pack freeze result:
