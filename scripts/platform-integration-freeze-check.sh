...
is_nested_gate_context() {
  ...
  [[ "${AION_PLATFORM_INTEGRATION_FREEZE_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
echo "Platform integration working tree summary:"
...
cat <<SUMMARY
Platform integration freeze result:
...
- aion_v0_1_0: ${tag_ref}
platform integration freeze PASS
SUMMARY
