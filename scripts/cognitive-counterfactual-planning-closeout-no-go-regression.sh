...
"$PYTHON_BIN" scripts/lib/cognitive_architecture_governance.py \
  --repo-root "$ROOT_DIR" \
  --mode counterfactual-planning-closeout-no-go
...
cat <<'SUMMARY'
cognitive counterfactual-planning closeout no-go result:
- runtime_effect=false
- api_route_added=false
- kernel_registration_added=false
- background_loop_added=false
- action_execution_enabled=false
- external_action_dispatch=false
...
- migrations=absent
cognitive counterfactual-planning closeout no-go PASS
SUMMARY
