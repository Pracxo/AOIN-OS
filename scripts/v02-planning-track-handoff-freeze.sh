...
is_nested_gate_context() {
  ...
  [[ "${AION_V02_PLANNING_TRACK_HANDOFF_FREEZE_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
echo "v0.2 planning track handoff freeze working tree summary:"
...
cat <<SUMMARY
v0.2 planning track handoff freeze result:
...
- aion_v0_1_0: ${tag_ref}
v0.2 planning track handoff freeze PASS
SUMMARY
