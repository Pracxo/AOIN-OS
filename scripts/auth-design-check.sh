...
aion206_auth_paths = {
    ...
    "services/brain-api/tests/test_knowledge_source_registry_authorization_docs.py",
    "services/brain-api/tests/test_knowledge_source_registry_authorization_validator.py",
}
...
def is_secure_runtime_integration_artifact(name: str) -> bool:
    return (
        ...
        or name.startswith("docs/release/v02-qualification-foundation-operator-evaluation-")
        or name.startswith("docs/release/v02-staging-qualification-")
        ...
        or name.startswith("operator-console-static/demo-data/operator-console-")
