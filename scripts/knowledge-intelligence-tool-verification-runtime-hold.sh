...
is_nested_gate_context() {
  ...
  [[ "${AION_TOOL_VERIFICATION_RUNTIME_HOLD_SKIP_FULL_CHECK:-}" == "1" ]] && return 0
...
tool_auth.validate_runtime_hold(ROOT)
PY
...
echo "knowledge intelligence tool verification runtime hold PASS"
