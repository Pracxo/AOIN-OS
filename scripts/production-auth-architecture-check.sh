...
for name in [*changed, *untracked]:
    ...
    if name in allowed_aion_178_runtime:
        continue
    if name in allowed_aion_181_runtime:
        continue
    if name in allowed_aion_184_runtime:
        continue
    if name in allowed_aion_186_runtime:
        continue
    if name in allowed_aion_188_runtime:
        continue
    if name in allowed_aion_190_runtime:
        continue
    if name in allowed_aion_192_runtime:
        continue
    ...
    if name.startswith(allowed_aion_231_prefixes):
        continue
    if name in allowed_aion_233_runtime:
        continue
    if name.startswith(allowed_aion_233_prefixes):
        continue
