"""Freeze gate runtime configuration integration tests."""
...
def test_freeze_gate_includes_runtime_config_checks() -> None:
    ...
    assert "runtime_config_validation_passed" in names
    assert "config_snapshot_created" in names
    assert "unsafe_feature_overrides_absent" in names
