...
POST_AION238_STATE = "secure_runtime_integration_program_complete"
...
def test_secure_runtime_current_state_after_aion236():
    ...
    aion237_implemented = program["program_state"] in {POST_AION237_STATE, POST_AION238_STATE}
    ...
    if program["program_state"] == POST_AION238_STATE:
