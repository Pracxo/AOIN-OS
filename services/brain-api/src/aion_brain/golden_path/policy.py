"""Policy helper for golden path services."""
...
def authorize_golden_path_action(
    ...
    *,
    ...
    resource_type: str = "golden_path",
    resource_id: str | None = None,
    risk_level: str = "low",
    context: dict[str, Any] | None = None,
    approval_present: bool = True,
) -> None:
    """Authorize one generic golden path action."""
...
__all__ = ["authorize_golden_path_action"]
