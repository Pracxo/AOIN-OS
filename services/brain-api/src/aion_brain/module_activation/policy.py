"""Policy helper for module activation gate services."""
...
def authorize_module_activation_action(
    ...
    *,
    ...
    resource_type: str = "module_activation",
    resource_id: str | None = None,
    risk_level: str = "low",
    context: dict[str, Any] | None = None,
    approval_present: bool = True,
) -> None:
    """Authorize one module activation metadata action."""
...
__all__ = ["authorize_module_activation_action"]
