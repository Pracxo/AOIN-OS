...
VisualTelemetryEventType = Literal[
    ...
    "dry_run_action_authorization_decided",
    "action_authorization_audit_completed",
    "auth_runtime_status_checked",
    "mock_claims_preview_created",
    "auth_runtime_audit_completed",
...
VisualNodeType = Literal[
    ...
    "action_authorization_audit",
    "auth_runtime_status",
    "mock_claims_preview",
    "auth_runtime_audit",
    "connector_runtime_status",
    "connector_manifest",
    "connector_egress_preview",
    "connector_ingress_preview",
    "connector_runtime_audit",
    "connector_simulation",
    "connector_policy_readiness",
    "connector_policy_catalog",
    "connector_authorization_matrix",
    "connector_policy_dry_run",
    "connector_policy_traceability",
    "connector_sandbox_boundary",
