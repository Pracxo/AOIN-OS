"""Policy helper for release candidate services."""
...
def authorize_rc_action(
    ...
    *,
    ...
    resource_type: str = "release_candidate",
    resource_id: str | None = None,
    risk_level: str = "low",
    context: dict[str, Any] | None = None,
    approval_present: bool = True,
) -> None:
    """Authorize one release candidate action through the policy boundary."""
