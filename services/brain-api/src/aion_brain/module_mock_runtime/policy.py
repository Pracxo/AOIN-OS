"""Policy helper for module mock runtime services."""
...
def authorize_module_mock_action(
    ...
    *,
    ...
    resource_type: str = "module_mock_runtime",
...
__all__ = ["authorize_module_mock_action"]
