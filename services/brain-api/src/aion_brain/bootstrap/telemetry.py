"""Best-effort visual telemetry for bootstrap."""
...
def emit_bootstrap_telemetry(
    ...
    *,
    ...
    """Emit visual telemetry without affecting bootstrap flow."""
...
__all__ = ["emit_bootstrap_telemetry"]
