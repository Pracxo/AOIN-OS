"""Policy helper for first-run bootstrap services."""
...
def authorize_bootstrap_action(
    ...
    *,
    ...
    resource_type: str = "bootstrap",
    resource_id: str | None = None,
    risk_level: str = "low",
    context: dict[str, Any] | None = None,
    approval_present: bool = True,
) -> None:
    """Authorize one generic bootstrap action."""
...
__all__ = ["authorize_bootstrap_action"]
