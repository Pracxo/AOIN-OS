"""Policy helper for module binding services."""
...
def authorize_module_binding_action(
    ...
    *,
    ...
    resource_type: str = "module_binding",
    resource_id: str | None = None,
    risk_level: str = "low",
    context: dict[str, Any] | None = None,
    approval_present: bool = True,
) -> None:
    """Authorize one generic module binding action."""
...
__all__ = ["authorize_module_binding_action"]
