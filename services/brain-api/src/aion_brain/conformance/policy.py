"""Policy helper for conformance services."""
...
def authorize_conformance_action(
    ...
    *,
    ...
    resource_type: str = "conformance",
    resource_id: str | None = None,
    risk_level: str = "low",
    context: dict[str, Any] | None = None,
    approval_present: bool = True,
) -> None:
    """Authorize one generic conformance action."""
...
__all__ = ["authorize_conformance_action"]
