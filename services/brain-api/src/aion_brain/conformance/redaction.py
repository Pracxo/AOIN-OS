"""Redaction helpers for conformance metadata."""
...
def redact_conformance_payload(value: dict[str, Any]) -> dict[str, Any]:
    """Return a redacted payload without preserving removed raw values."""

    redacted, _findings = redact_output_payload(_remove_protected_keys(value))
    return redacted
...
__all__ = ["redact_conformance_payload"]
