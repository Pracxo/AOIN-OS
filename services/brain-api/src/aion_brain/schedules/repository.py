...
aion_schedules = Table(
    ...
    Column("action_mode", Text, nullable=True),
    Column("target_payload", json_payload_type, nullable=True),
    Column("recurrence", json_payload_type, nullable=True),
    ...
    Column("last_due_at", DateTime(timezone=True), nullable=True),
    Column("last_tick_run_id", Text, nullable=True),
    Column("owner_scope", json_payload_type, nullable=True),
    ...
    Index("ix_aion_schedules_trace_id", "trace_id"),
    Index("ix_aion_schedules_actor_id", "actor_id"),
    Index("ix_aion_schedules_workspace_id", "workspace_id"),
    Index("ix_aion_schedules_target_type", "target_type"),
    Index("ix_aion_schedules_next_due_at", "next_due_at"),
    Index("ix_aion_schedules_last_tick_run_id", "last_tick_run_id"),
    Index("ix_aion_schedules_deleted_at", "deleted_at"),
