"""Best-effort audit and provenance helpers for prompt governance."""
...
def record_prompt_audit(
    ...
    *,
    ...
    """Record one prompt-governance audit entry without breaking the caller."""
    ...
    entry = record_audit_event(
        ...
        outcome=outcome,
        source_component="prompt_governance",
...
def create_prompt_provenance_link(
    ...
    *,
    ...
    """Create one prompt provenance link without breaking the caller."""
...
__all__ = ["create_prompt_provenance_link", "record_prompt_audit"]
