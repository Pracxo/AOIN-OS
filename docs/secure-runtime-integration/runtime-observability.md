...
Observability snapshots expose only safe counts, state, budget usage and integrity status. There is no external exporter, network export, log shipping or production health endpoint.
