...
The controlled pilot verified one short-lived offline assertion, claimed one replay key, rejected one exact replay, processed one request, simulated one dispatch, closed the session and retained zero temporary files.
