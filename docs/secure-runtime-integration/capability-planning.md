...
Capability plans are deterministic projections from the closed registry. Unknown capabilities, target substitution, risk downgrade, approval downgrade and nonzero side effects are rejected.
