# Side-Effect Budget Implementation
...
AION-230-SRI-0001 resource limits are enforced exactly. Every prohibited-effect counter must remain zero and any overflow fails closed.
