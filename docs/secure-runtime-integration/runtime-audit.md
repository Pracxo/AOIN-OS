...
InMemorySecureRuntimeAuditLedger appends redacted audit records in a per-session hash chain. Records contain fingerprints, event types and reason codes, not protected material.
