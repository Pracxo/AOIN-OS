...
AION-231 calls the existing OfflineIdentityAssertionVerificationPipeline through dependency injection, requires outcome verified_once, verifies issuer, audience, workspace, role, permission and scope bounds, and returns only redacted fingerprints.
