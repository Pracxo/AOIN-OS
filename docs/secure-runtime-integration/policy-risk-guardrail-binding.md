...
PolicyDecision, RiskAssessment and GuardrailDecision records are accepted as externally supplied evidence and bound read-only by fingerprint. The runtime creates no policy, risk or guardrail records.
