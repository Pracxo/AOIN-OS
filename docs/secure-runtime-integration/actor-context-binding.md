...
ActorContext is constructed from the verified request identity with actor_type local_operator, bounded roles, permissions and security scopes, no development simulation and no anonymous fallback.
