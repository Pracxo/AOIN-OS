...
Health readiness requires exact authorization, identity pipeline availability, local public-key registry availability, replay schema availability, clear kill switch and valid resource budgets.
