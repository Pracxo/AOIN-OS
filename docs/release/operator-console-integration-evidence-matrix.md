# Operator Console Integration Evidence Matrix
...
| --- | --- | --- |
| Pilot evidence | `examples/secure-runtime-integration/operator-console-integrated-local-runtime-pilot-evidence.json` | pass |
| Runtime hold | `examples/secure-runtime-integration/operator-console-runtime-hold.json` | pass |
| Static console evidence | `operator-console-static/demo-data/` | redacted |
