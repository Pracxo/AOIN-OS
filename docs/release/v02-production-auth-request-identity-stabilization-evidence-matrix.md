...
| AION-157 authorization | security reviewer | `v02-production-auth-request-identity-stabilization-authorization-no-go-regression.sh` | consumed by AION-158 PR 68 | `AION-157-PA-0004` authorized only disabled request identity stabilization and is now historical. |
...
## AION-159 Lifecycle Update

`AION-157-PA-0004` expired on AION-158 PR 68 merge and is no longer active or
reusable. `AION-159-PA-0005` is the successor active authorization for AION-160
