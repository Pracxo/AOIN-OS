# Secure Runtime Foundation Pilot

Authorization: `AION-230-SRI-0001`
Implementation task: `AION-231`
Formal closeout: `AION-232`

Pilot evidence is recorded in examples/secure-runtime-integration/local-operator-runtime-pilot-evidence.json with one verified assertion and one exact replay rejection.
