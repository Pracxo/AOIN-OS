# Self-Improvement Shadow Activation Authorization Transaction

Transaction: `AION-180-SI-0007`
...
Scope: `disabled-shadow-activation-request-approval-monitoring-deactivation-control-plane`.

Implementation task: `AION-181`. Formal closeout task: `AION-182`.
