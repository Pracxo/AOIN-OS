...
The AION-162 implementation is intentionally unintegrated.
...
- authorization_expires_on_aion_162_merge=true
...
Formal lifecycle closeout is deferred to AION-163.
