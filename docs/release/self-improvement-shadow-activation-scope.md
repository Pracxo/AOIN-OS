# Self-Improvement Shadow Activation Scope
...
Authorized AION-181 scope includes disabled activation contracts, exact approval binding, local reference-set binding, operator-principal binding, output boundary, run budgets, monitoring, deactivation, kill switch, incident evidence, audit provenance, diagnostics, and simulation-only decisions.
