# Knowledge Intelligence Claim Graph Security Evidence
...
Evidence bindings reference source-registry, source-snapshot, provenance, citation, lineage, and source-independence group IDs. Evidence roles remain descriptive and never verify support or falsify a claim.
