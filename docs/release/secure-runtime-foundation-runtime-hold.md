# Secure Runtime Foundation Runtime Hold

Authorization: `AION-230-SRI-0001`
Implementation task: `AION-231`
Formal closeout: `AION-232`

Runtime hold verifies local operator runtime availability while keeping production authentication, providers, connectors, tools, modules, deployment and release flags false.
