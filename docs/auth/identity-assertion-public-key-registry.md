...
AION-164 replay protection does not change public-key registry semantics. Public keys remain verification-only; replay evidence stores issuer and assertion fingerprints but never raw key material, private keys, signatures, or verified claims.
