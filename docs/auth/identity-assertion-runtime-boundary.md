...
## Replay Protection Runtime Hold

AION-164 adds replay-protection source and evidence only. Runtime request parsing, middleware registration, request authentication, ActorContext application, RequestIdentityContext application, provider calls, routes, SDK/CLI surfaces, migrations, v0.2 tags, and v0.2 releases remain disabled or absent.
