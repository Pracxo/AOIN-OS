...
## Replay Protection Prerequisite

Future request-authentication integration must treat AION-164 replay protection as a prerequisite, but AION-164 itself does not authorize runtime integration. Production schema provisioning, runtime registration, and lifecycle closeout require later explicit authorization.
