# Controlled Local Continual-Learning Pilot Boundary

AION-228 may implement only the recorded source scope and an uninstalled operator runner. AION-227 records that scope but creates none of those files.
