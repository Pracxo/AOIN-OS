# Continual-Learning Outcome Policy

Each cycle terminates as completed, abstained, rolled_back or failed. Safety and policy failures force abstention or rollback; quality gains cannot override hard gates.
