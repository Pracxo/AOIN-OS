# Continual-Learning Temporary Persistence

Pilot persistence is temporary, isolated, approval-bound and cleaned after session close. Each persistence transaction requires a knowledge-steward approval and memory-operator approval and writes no production memory.
