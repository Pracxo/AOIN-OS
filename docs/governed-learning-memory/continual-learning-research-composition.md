# Continual-Learning Research Composition

AION-228 may compose existing public research APIs only through explicit operator invocation, exact URLs, exact domain allowlists and existing DNS, HTTPS, TLS, redirect, robots and provenance controls. Crawling, search-provider integration and automatic source discovery remain disabled.
