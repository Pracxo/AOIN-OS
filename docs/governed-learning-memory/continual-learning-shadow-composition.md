# Continual-Learning Shadow Composition

The pilot may compose AION-226 public APIs. Shadow overlays remain in memory, bind the cycle, expire before session close and roll back on failure.
