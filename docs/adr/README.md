...
- [0126: v0.2 Submission Registry Stabilization](0126-v02-submission-registry-stabilization.md) - Stabilizes the submission registry preview, freezes the pre-approval queue baseline, and closes out request candidates while keeping all approvals false.
- [0127: v0.2 Pre-Approval Review Board](0127-v02-preapproval-review-board.md) - Adds review board routing, submission review routing, reviewer role matrix, and decision readiness boundaries while keeping all approvals false.
- [0128: v0.2 Review Board Stabilization](0128-v02-review-board-stabilization.md) - Stabilizes review board routing, reviewer quorum evidence, and decision-readiness baselines while keeping review, routing, submission, and implementation approvals false.
- [0129: v0.2 Decision Package Preview](0129-v02-decision-package-preview.md) - Adds the decision package preview, approval-readiness evidence bundle, runtime decision boundary, and no-go checks while keeping all approvals false.
- [0130: v0.2 Decision Package Stabilization](0130-v02-decision-package-stabilization.md) - Stabilizes the decision package preview, freezes approval readiness, and closes the runtime decision boundary while keeping all approvals false.
...
- [0135: v0.2 Runtime Approval Board Preview](0135-v02-runtime-approval-board-preview.md) - Adds the runtime approval board preview, approval vote record guard, and go/no-go ledger boundary while keeping board, vote, ledger, release, and implementation approvals false.
- [0136: v0.2 Runtime Approval Board Stabilization](0136-v02-runtime-approval-board-stabilization.md) - Stabilizes the runtime approval board preview, approval vote record freeze, and go/no-go ledger evidence baseline while keeping board, vote, ledger, release, and implementation approvals false.
- [0137: v0.2 Runtime Approval Board Final Review](0137-v02-runtime-approval-board-final-review.md) - Finalizes the runtime approval board review, closes approval vote records, and locks the go/no-go ledger while keeping board, vote, ledger, release, and implementation approvals false.
- [0137: v0.2 Runtime Approval Board Final Review](0137-v02-runtime-approval-board-final-review.md) - Finalizes the runtime approval board review, closes approval vote records, and locks the go/no-go ledger while keeping board, vote, ledger, release, and implementation approvals false.
- [0138: v0.2 Implementation Authorization Preview](0138-v02-implementation-authorization-preview.md) - Defines the explicit approval record schema and runtime enablement guard boundary while keeping authorization, guard release, runtime, release, and implementation approvals false.
- [0139: v0.2 Implementation Authorization Stabilization](0139-v02-implementation-authorization-stabilization.md) - Stabilizes the implementation authorization preview, explicit approval record freeze, and runtime enablement guard evidence baseline while keeping authorization, guard release, runtime, release, and implementation approvals false.
- [0140: v0.2 Implementation Authorization Final Review](0140-v02-implementation-authorization-final-review.md) - Finalizes the implementation authorization review, explicit approval record closeout, and runtime enablement guard final lock while keeping authorization, guard release, runtime, release, and implementation approvals false.
- [0141: v0.2 Authorization Track Closeout](0141-v02-authorization-track-closeout.md) - Closes the v0.2 authorization governance track, adds approval-chain master evidence, and creates the runtime enablement master lock while keeping runtime, release, implementation, and guard-release approvals false.
- [0142: v0.2 Production Auth Implementation Authorization](0142-v02-production-auth-implementation-authorization.md) - Authorizes the single scoped production-auth-core implementation transaction for AION-152 while keeping runtime auth disabled and guard releases locked.
- [0143: v0.2 Disabled Production Auth Core Implementation](0143-v02-disabled-production-auth-core-implementation.md) - Implements the internal disabled production-auth core separately from the auth-runtime preview package while keeping all runtime surfaces disabled.
- [0144: v0.2 Production Auth Core Stabilization Authorization](0144-v02-production-auth-core-stabilization-authorization.md) - Closes the consumed AION-151 production-auth authorization and creates the single active AION-153 stabilization authorization for future AION-154 work.
- [0145: v0.2 Production Auth Core Stabilization](0145-v02-production-auth-core-stabilization.md) - Stabilizes the disabled internal production-auth core with canonical evidence, fingerprints, reason codes, immutability, idempotency, concurrency, redaction, and route-absence checks while keeping runtime auth disabled.
- [0146: v0.2 Production Auth Request Identity Boundary Authorization](0146-v02-production-auth-request-boundary-authorization.md) - Closes the consumed AION-153 stabilization authorization and creates the single active AION-155 request-boundary authorization for future AION-156 work.
- [0147: v0.2 Disabled Production Auth Request Identity Boundary](0147-v02-disabled-production-auth-request-identity-boundary.md) - Implements the AION-155-authorized disabled observe-only request identity boundary while keeping runtime authentication, identity verification, routes, providers, packages, migrations, SDK/CLI runtime surfaces, v0.2 tags, and v0.2 releases absent or disabled.
- [0148: v0.2 Production Auth Request Identity Stabilization Authorization](0148-v02-production-auth-request-identity-stabilization-authorization.md) - Closes the consumed AION-155 request identity boundary authorization and creates the single active AION-157 stabilization authorization for future AION-158 work while keeping runtime authentication disabled.
- [0149: v0.2 Production Auth Request Identity Stabilization](0149-v02-production-auth-request-identity-stabilization.md) - Replaces the disabled request identity boundary middleware with pure ASGI mechanics, forged-state defence, duplicate registration prevention, streaming/body passthrough, cancellation handling, diagnostics, and runtime-hold gates while keeping runtime authentication disabled.
- [0150: v0.2 Actor Context Trust Boundary Remediation Authorization](0150-v02-actor-context-trust-boundary-authorization.md) - Closes AION-157 as consumed by AION-158 and creates AION-159-PA-0005 as the active AION-160 authorization to remove non-development trust in actor-context headers while keeping runtime authentication disabled.
- [0151: v0.2 Actor Context Trust Boundary Remediation](0151-v02-actor-context-trust-boundary-remediation.md) - Implements the fail-closed actor-context resolver, isolates development identity simulation, preserves request identity precedence and request correlation, and keeps production authentication disabled.
- [0152: v0.2 Offline Ed25519 Identity Assertion Verification Authorization](0152-v02-offline-ed25519-identity-assertion-verification-authorization.md) - Closes AION-159 as consumed by AION-160 and creates AION-161-PA-0006 as the active AION-162 authorization for offline Ed25519 identity assertion verification while keeping runtime authentication disabled.
...
- [0156: Governed Self-Improvement Control Plane](0156-governed-self-improvement-control-plane.md) - Closes the consumed AION-163 replay-protection authorization and creates AION-165-SI-0001 for AION-166 governance-plane work while keeping self-rewrite, automatic merge, production deployment, and model-weight training disabled.
- [0157: Self-Improvement Evaluation Authorization](0157-self-improvement-evaluation-authorization.md) - Closes AION-165-SI-0001 as consumed by AION-166 and creates AION-167-SI-0002 for AION-168 immutable evaluation-plane work while keeping source rewriting, PR creation, automatic approval, production deployment, and model-weight training disabled.
- [0158: Self-Improvement Experiment Authorization](0158-self-improvement-experiment-authorization.md) - Closes AION-167-SI-0002 as consumed by AION-168 and creates AION-169-SI-0003 for AION-170 proposal and experiment engine work while keeping source mutation, Git activity, PR creation, merge, deployment, and model-weight changes disabled.
- [0159: Self-Improvement Rewrite Authorization](0159-self-improvement-rewrite-authorization.md) - Closes AION-169-SI-0003 as consumed by AION-170 and creates AION-171-SI-0004 for AION-172 approval-bound isolated source rewrite and PR control while keeping autonomous runtime rewrite, automatic merge, production deployment, and model-weight changes disabled.
- [0160: Self-Improvement Canary Authorization](0160-self-improvement-canary-authorization.md) - Closes AION-171-SI-0004 as consumed by AION-172 and creates AION-173-SI-0005 for AION-174 approval-bound canary, rollback, outcome-ledger, and adaptive-policy work while keeping production canary, policy relaxation, runtime self-approval, and autonomous production activation disabled.
- [0161: Governed Self-Improvement Platform Complete](0161-governed-self-improvement-platform-complete.md) - Closes AION-173-SI-0005 as consumed by AION-174 and records the implemented-disabled governed self-improvement platform as ready for user evaluation.
- [0162: Controlled Self-Improvement Shadow-Mode Authorization](0162-controlled-self-improvement-shadow-mode-authorization.md) - Creates AION-177-SI-0006 as the single active AION-178 authorization for disabled, observation-only shadow-mode implementation while keeping runtime activation, source rewrite, Git writes, PR creation, merge, deployment, providers, connectors, model training, v0.2 release, and aion-v0.1.0 movement disabled or absent.
- [0163: Controlled Self-Improvement Shadow-Mode Plane](0163-controlled-self-improvement-shadow-mode-plane.md) - Implements the AION-177-authorized controlled shadow plane as operator-invoked, read-only, advisory, non-influencing, and runtime-disabled pending AION-179 closeout.
- [0164: Controlled Shadow-Mode Operator Evaluation](0164-controlled-shadow-mode-operator-evaluation.md) - Closes AION-177-SI-0006 after AION-178 evaluation with a PASS recommendation for future controlled activation authorization review while keeping runtime activation and write paths disabled.
- [0165: Controlled Shadow Activation Control-Plane Authorization](0165-controlled-shadow-activation-control-plane-authorization.md) - Creates AION-180-SI-0007 as the single active AION-181 authorization for a disabled activation control plane while keeping actual activation, production exposure, source mutation, Git writes, PR creation, approval creation, merge, promotion, canary, deployment, model training, v0.2 releases, and aion-v0.1.0 movement disabled or absent.
- [0166: Controlled Shadow Activation Control Plane](0166-controlled-shadow-activation-control-plane.md) - Implements the disabled simulation-only activation control plane.
- [0167: Shadow Activation Control-Plane Operator Evaluation](0167-shadow-activation-control-plane-operator-evaluation.md) - Records AION-SACE-001 read-only evaluation, AION-180 closeout, and the future actual activation authorization boundary.
- [0168: Controlled Knowledge Intelligence Research Acquisition Authorization](0168-controlled-knowledge-intelligence-research-acquisition-authorization.md) - Creates the Knowledge Intelligence Program authorization for disabled controlled research acquisition while keeping runtime, network, crawler, promotion, mutation, deployment, and model training disabled.
- [0169: Controlled Research Acquisition and Immutable Source Snapshots](0169-controlled-research-acquisition-and-immutable-source-snapshots.md) - Implements the AION-204-authorized disabled research acquisition and immutable source-snapshot core.
- [0170: Research Acquisition Evaluation and Source Provenance Registry Authorization](0170-research-acquisition-evaluation-and-source-provenance-registry-authorization.md)
- [0171: Append-Only Source Provenance Registry Core](0171-append-only-source-provenance-registry-core.md) - Implements the AION-206-authorized metadata-only source registry core while persistent writes, runtime registration, source-body storage, claim verification, knowledge promotion, and belief mutation remain disabled.
