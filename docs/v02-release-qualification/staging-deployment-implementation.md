...
Documents the generated Compose deployment plan: five run-owned services, pull never, no-build up, one internal network and loopback-only port publication.
