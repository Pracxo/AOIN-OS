...
Documents the strict Pydantic v2 contracts for authorization, source snapshots, build plans, artifacts, SBOM, provenance, deployment, health, security, observability, rollback, cleanup and evidence. Every retained model forbids extra fields and rejects protected material.
