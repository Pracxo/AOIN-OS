# AION-241 Environment

Defines one internal Compose network, five services, loopback-only Brain API exposure, dependency services without host ports and no production environment.
