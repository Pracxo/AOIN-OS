# AION-241 Operator Runbook

Operators run the uninstalled local runner with AION-240-V02RQ-0002, a new secure temporary root and RUN_CONTROLLED_ISOLATED_STAGING_QUALIFICATION. The runner handles cleanup on success or failure.
