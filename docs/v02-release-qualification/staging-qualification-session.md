...
Describes the single active local qualification session, operator confirmation fingerprint, UTC lifecycle timestamps and fail-closed close semantics. The repository is in-memory only.
