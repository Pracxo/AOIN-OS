# AION-241 Observability

Captures bounded local event counts, health/readiness transitions, state counts, security counts, degradation and recovery timestamps, cleanup counts and fingerprints only. Raw logs are not committed.
