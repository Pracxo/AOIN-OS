# AION-241 Source Snapshot

Requires the pilot to archive the immutable implementation commit using Git archive, extract with traversal checks and bind file-count, byte-count, tree and archive fingerprints into evidence.
