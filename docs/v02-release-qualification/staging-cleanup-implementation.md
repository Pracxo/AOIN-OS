...
Requires compose down with volumes, removal of all run-owned containers, network, volumes, images, temporary files, identity material and replay fixtures, followed by inventory comparison.
