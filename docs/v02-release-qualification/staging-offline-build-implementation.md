# AION-241 Offline Build

Requires two local Docker buildx builds using a generated staging Dockerfile, pull=false, network=none and only pre-existing local images. No pip, apt, package download, curl or wget operation is authorized.
