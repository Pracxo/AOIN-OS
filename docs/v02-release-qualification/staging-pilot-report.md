# AION-241 Pilot Report

The committed pilot report is written only after the controlled local Docker pilot completes and cleanup verifies zero run-owned resources. Before that, this document describes the report schema and required counters.
