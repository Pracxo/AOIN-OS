# AION-241 Docker Context Boundary

Constrains AION-241 to Docker Desktop's existing local Linux daemon, rejects remote contexts and records only safe fingerprints for context, version, Buildx and Compose state.
