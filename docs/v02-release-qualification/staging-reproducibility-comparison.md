# AION-241 Reproducibility

Records invariant comparison across the two offline builds. Byte-for-byte reproducibility is reported only when actual image IDs match.
