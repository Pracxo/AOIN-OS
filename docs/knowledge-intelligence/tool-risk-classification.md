...
Operation classes: `pure_compute`, `deterministic_parser`, `deterministic_validator`, `local_fixture_read`, `filesystem_read`, `external_read`, `external_write`, `system_command`, `browser`, `connector`, `model_provider`, `source_write`, `git_write`, `deployment`, `privileged`.
Risk classes: `minimal`, `low`, `moderate`, `high`, `critical`.
