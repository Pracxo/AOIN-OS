# Verified Knowledge Threat Model
...
- Evidence laundering, duplicate amplification, scope loss, confidence amplification, hidden contradiction, dissent suppression, tool-output-as-fact, engagement-as-fact, stale evidence acceptance, missing lineage, automatic promotion, cognitive-memory contamination, persistent candidate write, public-network activation, source mutation, Git mutation, model training, authorization reuse, and evaluation-as-approval all fail closed.
