# Structural Conflict Candidates
...
Structural conflict candidates require matching subject and predicate, explicit overlap across time, jurisdiction, and version scope, and either opposite polarity on the same object, single-valued object conflict, or mutual exclusivity. A candidate assigns no winner.
