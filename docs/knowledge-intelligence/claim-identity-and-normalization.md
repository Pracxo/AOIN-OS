# Claim Identity and Normalization
...
Identity fingerprints bind normalized subject, predicate, typed object, polarity, modality, predicate cardinality, mutual-exclusion flag, and explicit scope. The human statement is stored for operator readability and cannot override structured identity.
