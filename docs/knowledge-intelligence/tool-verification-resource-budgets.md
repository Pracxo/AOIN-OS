# Tool Verification Resource Budgets
...
Resource limits are recorded in `examples/knowledge-intelligence/tool-verification-resource-budget.json`; all actual execution, shell, network, DNS, browser, connector, provider, filesystem mutation, source mutation, Git, PR, approval, deployment, knowledge promotion, belief mutation, and model training budgets are zero.
